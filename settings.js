...
global.owner = process.env.OWNER_NUMBER  || '254704706667' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || ' VAJIRA-MD=CA9lxYIZ#IEVt-dSANroAcIk2BIvCv8T8TL8MN8wiCUlwbwtFkF8' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "254704706667,254704706667" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '1536': process.env.MAX_SIZE,/*add this in megabytes*/    
OWNER_NAME: process.env.OWNER_NAME || 'LATRODECT' ,
